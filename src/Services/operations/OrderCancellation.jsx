...
const {
  SET_CANCELLATION_INDICATORS,
  DESET_CANCELLATION_INDICATORS,
  ORDER_CANCELLATION,
} = cancellationEndpoints;

export function setOrderCancellationIndicators(
  token,
  orderId,
  dispatch,
  navigate,
...
export function desetOrderCancellationIndicators(
  token,
  orderId,
  dispatch,
  navigate,
...
export function cancellationOfOrder(
  token,
  orderId,
  reason,
  dispatch,
