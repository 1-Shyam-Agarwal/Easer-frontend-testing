...
import { resendOTP } from '../../Services/operations/Auth.js';
...
import {
  ...
  setPrimaryDisable,
  setSecondaryDisable,
} from '../../Slices/DisableFunctionality.jsx';
...
const SignupPage = () => {
  ...
  useEffect(() => {
    getRegisteredCollegeList(setCollegeData, setPrimaryLoading).then(() => {
        ...
        <div className="flex justify-center mt-[-3rem] items-center min-h-screen bg-gray-100 overflow-y-hidden cursor-default">
          <div className="flex flex-col items-center justify-center h-[100%] w-7/8 md:w-1/2">
            <div className="flex flex-col items-center justify-center w-[85%]">
              ...
              >
                <Lottie animationData={signupAnimation} className="w-16 h-16" />
                  ...
                  {showOTPSection ? (
                    ...
                    >
                      ...
                      {isValid && (
                        <button
                          type="submit"
                          className={` ${primaryDisable ? 'bg-blue-300 cursor-not-allowed' : 'bg-blue-600 cursor-default hover:bg-blue-700'} text-white p-3 rounded-[5px] mt-6 `}
                          disabled={primaryDisable}
                        >
                          Create Account
                        </button>
