...
const LoginPage = () => {
  ...
  function submitEmailHandler(data) {
    handlePreCustomLoginChecksAndSendOtp(data.email , setPrimaryDisable , setLoginData , setWindowSwitch , dispatch);
  }
  ...
  {
      verifyPasswordHandler(loginData?.email , data?.password , navigate , setPrimaryDisable , dispatch);
  }
  ...
  function validateOTP(e)
  {
      ...
      handleVerifyLoginOtp(loginData?.email , otp , setPrimaryDisable , dispatch , navigate);
  }
