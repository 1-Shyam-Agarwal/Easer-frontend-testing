      ...
      <div className="max-w-2xl mx-auto bg-gray-50  overflow-hidden">
        ...
        <div className="p-8">
          ...
          <p className="text-gray-700 mb-4">
            Buddy, it's your chance to shine in the{' '}
            <span className="text-blue-600 font-semibold">
              Contributor Page
            </span>{' '}
            of Easer! Help your friends and classmates by uploading your
            complete chapter notes or helpful documents.
          </p>
          <p className="text-gray-700 mb-6">
            We're gathering notes to create a valuable resource. When our
            collection is ready, all students will get access. Every quality
            submission—even if it's not selected—earns you recognition on our{' '}
            <span className="text-blue-600 font-semibold">
              Contributors Page
            </span>
            .
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-gray-600">
                  <ul className="list-disc pl-5 space-y-1">
                    ...
                    <li>
                      Only upload original content or properly attributed
                      material
                    </li>
