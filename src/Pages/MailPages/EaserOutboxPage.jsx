...
const EaserOutboxPage = () => {
  ...
  useEffect(() => {
    ...
    getFilteredVendorsWithMinimumDetails(setLoading, setFilteredVendorsData, token);
  },[token]);   
  ...
  function sendMail(uploadedDocs , vendor , setLoading)
  {
        ...
        createOutboxMail(mailDocs , vendor  , token , setLoading , toggleComposeModelVisibility);
  }
        ...
        <div>
          {
              ...
              (
                  <div className="flex items-center justify-between px-6 py-3 bg-gray-50 text-xs font-semibold text-gray-600 uppercase tracking-wider ">
                    {/* Receiver */}
                    <div className="flex items-center gap-2 w-1/4 min-w-[150px]">Receiver</div>
